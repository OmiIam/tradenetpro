        ...
        <div className="bg-white shadow-lg rounded-lg p-8">
          ...
          <div className="prose max-w-none">
            ...
            <p className="text-gray-600 mb-4">
              We collect information you provide directly to us, such as when you create an account, make trades, or contact us for support.
            </p>
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">5. Cookies and Tracking</h2>
            <p className="text-gray-600 mb-4">
              We use cookies and similar tracking technologies to enhance your experience and analyze platform usage patterns.
            </p>
            ...
            <p className="text-gray-600 mb-4">
              If you have any questions about this Privacy Policy, please contact us at privacy@tradenet.im
            </p>
